    ...
    <div className="min-h-screen bg-slate-950 pb-20">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/dashboard" className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition shadow-lg">
              Open Dashboard
            </Link>
      ...
      <footer className="py-8 px-4 border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-gray-400 text-sm">© 2026 CAEFTS. All rights reserved.</div>
...
function FeatureCard({ icon, title, description }: { icon: string; title: string; description: string }) {
  return (
    <div className="p-6 bg-slate-900 rounded-xl border border-white/10 hover:border-blue-500/50 transition">
...
function UseCaseCard({ type, icon, scenario, actions }: { type: string; icon: string; scenario: string; actions: string[] }) {
  return (
    <div className="p-6 bg-slate-900 rounded-xl border border-white/10">
      <div className="flex items-center gap-3 mb-4">
        <span className="text-3xl">{icon}</span>
        <div className="text-sm font-semibold text-red-400">{type}</div>
      </div>
